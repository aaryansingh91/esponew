package com.rewards.espotask.fragments;
...
import com.rewards.espotask.R;
import com.rewards.espotask.TournamentMatchesAdaptor;
import com.rewards.espotask.TournamentMatchesItem;
                ...
                response -> {
                    ...
                    try {
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            if (matchStatus == 2) {  // Filter for upcoming matches
